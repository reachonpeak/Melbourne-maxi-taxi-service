...
export const metadata = {
  title: 'Contact Us — MelbourneMaxiTaxi',
  description: 'Get in touch with MelbourneMaxiTaxi. Available 24/7 for phone bookings, queries, and airport transfer support.',
          ...
          <div className="areas-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '40px' }}>
            ...
            <div className="reveal" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                 <a href={`tel:${PHONE}`} style={{ display: 'flex', alignItems: 'center', gap: '16px', color: 'var(--ink-light)', textDecoration: 'none', fontSize: '1.1rem', fontWeight: 600 }}>
                 ...
                 <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '16px', color: 'var(--ink-light)', textDecoration: 'none', fontSize: '1.1rem', fontWeight: 600 }}>
                ...
                <a href={`mailto:${EMAIL}`} style={{ display: 'flex', alignItems: 'center', gap: '16px', color: 'var(--ink-light)', textDecoration: 'none', fontSize: '1.1rem', fontWeight: 600 }}>
                  <div style={{ width: 48, height: 48, borderRadius: '50%', backgroundColor: 'rgba(255, 114, 33, 0.1)', color: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="20" height="20">
