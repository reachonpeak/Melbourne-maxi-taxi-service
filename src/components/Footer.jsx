          ...
          <div>
            ...
            <ul className="contact">
              ...
              <li>
                ...
                <a href="tel:+61455906197">+61 455 906 197</a>
              </li>
              <li>
                ...
                <a href="mailto:melbournemaxicabservice@gmail.com">melbournemaxicabservice@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="footer-bottom">
          <span>© {new Date().getFullYear()} Melbourne Maxi Cab Service. All rights reserved.</span>
